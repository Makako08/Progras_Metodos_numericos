...
%fr = @(r) (exp(-0.005*r) * cos(sqrt(2000 - (0.01*(r)^2)) *(0.05)))-(0.01);
%fr = @(r) (exp((-t/(2*l))*r) * cos(sqrt((1/(l*c)) - (((1/(2*l))^2)*(r)^2)) *(t)))-(q);
%fr = @(r) (exp((-(0.05)/(2*(5)))*r) * cos(sqrt((1/((5)*(0.0001))) - (((1/(2*(5)))^2)*(r)^2)) *(0.05)))-(0.01);
%[res fx ea iter]=bisect(fr,0.01,400)